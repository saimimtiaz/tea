...
<body>
<?php if (isset($_GET['name'])){$name=$_GET['name'];	}else{$name = 'Friend';} ?>
<?php if (isset($_GET['mac'])){$mac=$_GET['mac'];	}else{echo "ref is miising";die; } ?>
<h1>Hello <?php echo ucfirst($name); ?> <span> We need some information to update our record</span></h1>

<a class="link" target="_parent" href="/tea/form.php?name=<?php echo $name; ?>&mac=<?php echo $mac?>">Click here to fill the form</a>
	</body>